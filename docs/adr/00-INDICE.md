...
| [ADR-027](ADR-027-identidad-y-caducidad-del-gate-copiable.md) | Identidad y autocaducidad del gate copiable | Aceptado | `scripts/check_sizes.py` (`GATE_VERSION`, `gate_staleness`) | [M6-deriva-del-gate-copiable](../proposals/M6-deriva-del-gate-copiable.md) | 2026-09-08 |
